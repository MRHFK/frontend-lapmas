...
class UserAddMedisScreen extends StatefulWidget {
  final Function onSubmit;

  const UserAddMedisScreen({super.key, required this.onSubmit});

  @override
  _UserAddMedisScreenState createState() => _UserAddMedisScreenState();
}

class _UserAddMedisScreenState extends State<UserAddMedisScreen> {
