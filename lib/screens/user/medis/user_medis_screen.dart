...
import 'package:frontend_lapmas/screens/user/medis/user_add_medis_screen.dart';
import 'package:frontend_lapmas/screens/user/medis/user_detail_medis_screen.dart';
import 'package:frontend_lapmas/screens/user/user_home_screen.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class UserMedisScreen extends StatefulWidget {
  const UserMedisScreen({super.key});

  @override
  _UserMedisScreenState createState() => _UserMedisScreenState();
}

class _UserMedisScreenState extends State<UserMedisScreen> {
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => UserDetailMedisScreen(
                                medis: medis,
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    UserAddMedisScreen(onSubmit: _fetchBencanas)),
          );
        },
