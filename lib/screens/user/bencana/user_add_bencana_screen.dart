...
class UserAddBencanaScreen extends StatefulWidget {
  final Function onSubmit;

  const UserAddBencanaScreen({super.key, required this.onSubmit});

  @override
  _UserAddBencanaScreenState createState() => _UserAddBencanaScreenState();
}

class _UserAddBencanaScreenState extends State<UserAddBencanaScreen> {
