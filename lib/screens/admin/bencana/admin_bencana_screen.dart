...
import 'package:frontend_lapmas/screens/admin/bencana/admin_detail_bencana_screen.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class AdminBencanaScreen extends StatefulWidget {
  const AdminBencanaScreen({super.key});

  @override
  _AdminBencanaScreenState createState() => _AdminBencanaScreenState();
}

class _AdminBencanaScreenState extends State<AdminBencanaScreen> {
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => AdminDetailBencanaScreen(
                                bencana: bencana,
